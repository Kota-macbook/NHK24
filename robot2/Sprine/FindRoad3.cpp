...
int* Astar(int* NodeNum,char* MapDefault,int SizeX,int SizeY,float OpenNode[][3],int OpenNodeNum,char MapJudge);
...
int* Astar(int* AnsNodeNum,char* MapDefault,int SizeX,int SizeY,float OpenNode[][3],int OpenNodeNum,char MapJudge){
	int i,j,k;
	// setup---------------------------------------------------------------------
