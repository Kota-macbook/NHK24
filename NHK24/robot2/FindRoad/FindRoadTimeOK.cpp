...
int Astar(char* MapDefault,int SizeX,int SizeY,float OpenNode[][3],int OpenNodeNum,char MapJudge);
...
int main(void){
	...
	x= Astar(*MapDefault,SizeX,SizeY,OpenNode,OpenNodeNum,MapJudge);
