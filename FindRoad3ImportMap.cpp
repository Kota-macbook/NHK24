...
void ReMakeMap(int8_t* MapDefault,int8_t* ReMap,int MaxMoveX_P,int MaxMoveX_N,int MaxMoveY_P,int MaxMoveY_N,int SizeX,int SizeY,int MapJudge,int MapNoUse,int MapCanUse);
int* Astar(int* NodeNum,int8_t* MapDefault,int SizeX,int SizeY,float OpenNode[][3],int OpenNodeNum,int8_t MapJudge);
...
int main(void){
	...
	int* AnsNodes;
    int AnsNodeNum;
	AnsNodes= Astar(&AnsNodeNum,MapDefault,SizeX,SizeY,OpenNode,OpenNodeNum,MapJudge);
...
int* Astar(int* AnsNodeNum,int8_t* MapDefault,int SizeX,int SizeY,float OpenNode[][3],int OpenNodeNum,int8_t MapJudge){
	int i,j,k;
	// setup---------------------------------------------------------------------
	
	const int8_t 			MapNoUse = 100;
	const int8_t 			MapCanUse = 0;
	const int8_t 			MapOpened = 25;
